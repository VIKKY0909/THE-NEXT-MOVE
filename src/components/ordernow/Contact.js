...
function Contact() {
  ...
  useEffect(() => {
    const { firstName, lastName, email, phone, quantity } = formData;
    const isFormValid = firstName && lastName && email && phone && quantity;
      ...
      >
        <div className="w-full h-full p-0 m-0 overflow-x-hidden bg-gray-900 font-sans">
          ...
          <div className="flex flex-col items-center justify-center px-4 md:flex-row">
            <div className="p-8 bg-gray-700 rounded-xl md:w-1/3 md:mr-4">
            ...
            <div className="p-8 bg-white rounded-xl md:w-2/3">
